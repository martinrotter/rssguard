...
class XmppNetwork : public QObject {
  ...
  public:
    ...
    explicit XmppNetwork(QObject* parent = nullptr);
    ...
    void prepareFeedFetching(XmppServiceRoot* root,
    ...
    XmppServiceRoot::Service service() const;
    void setService(XmppServiceRoot::Service service);
    ...
    void setRoot(XmppServiceRoot* root);
  ...
  private:
    ...
    XmppServiceRoot::Service m_service;
    QString m_username;
    QString m_password;
    QString m_baseUrl;
    int m_batchSize;
