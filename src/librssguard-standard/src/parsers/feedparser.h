...
class FeedParser {
  ...
  protected:
    ...
    virtual QList<QSharedPointer<Enclosure>> jsonMessageEnclosures(const QJsonObject& msg_element) const;
    ...
    virtual QList<QSharedPointer<Enclosure> > objMessageEnclosures(const QVariant& msg_element) const;
  ...
  protected:
    ...
    QList<QSharedPointer<Enclosure>> xmlMrssGetEnclosures(const QDomElement& msg_element) const;
